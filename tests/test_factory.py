...
def test_parallel_heuristic(args: tuple[Any, ...], expected: bool) -> None:
    if supports_parallel():
        ...
        assert not parallel_heuristic(*args)


def _get_factory_params() -> list[Any]:
    ...
    return [
        ...
        (
            factory_reduce_vals_indexed,
            (1, False),
            grouped.reduce_vals_indexed_fromzero,
        ),
        (
            factory_reduce_vals_indexed,
            (2, False),
            grouped_cov.reduce_vals_indexed_fromzero,
        ),
        # rolling_vals
...
def _get_factory_params_parallel() -> list[Any]:
    ...
    return [
        ...
        (
            factory_reduce_vals_indexed,
            (1, True),
            grouped_parallel.reduce_vals_indexed_fromzero,
        ),
        (
            factory_reduce_vals_indexed,
            (2, True),
            grouped_cov_parallel.reduce_vals_indexed_fromzero,
        ),
        # rolling_vals
