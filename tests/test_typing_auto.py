...
def test_cmomy_convert_moments_to_comoments() -> None:
    ...
    check(
        assert_type(
            cmomy.convert.moments_to_comoments(data_dataarray_or_set, mom=(1, -1), dtype=float32),
...
def test_cmomy_convert_comoments_to_moments() -> None:
    ...
    check(
        assert_type(
            cmomy.convert.comoments_to_moments(data_dataarray_or_set, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_reduce_data() -> None:
    ...
    check(
        assert_type(
            cmomy.reduce_data(data_dataarray_or_set, dim="dim_0", mom_ndim=1, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_reduce_vals() -> None:
    ...
    check(
        assert_type(
            cmomy.reduce_vals(vals_dataarray_or_set, dim="dim_0", mom=2, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_reduce_data_grouped() -> None:
    ...
    check(
        assert_type(
            cmomy.reduce_data_grouped(data_dataarray_or_set, dim="dim_0", mom_ndim=1, by=by, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_reduce_data_indexed() -> None:
    ...
    check(
        assert_type(
            cmomy.reduce_data_indexed(data_dataarray_or_set, dim="dim_0", mom_ndim=1, index=index, group_start=group_start, group_end=group_end, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_reduce_vals_grouped() -> None:
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float32, axis=0, mom=2, by=by),
            NDArray[float32],
        ),
        np.ndarray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float64, axis=0, mom=2, by=by),
            NDArray[float64],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_arrayany, axis=0, mom=2, by=by),
            NDArray[Any],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_any, axis=0, mom=2, by=by),
            Any,
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray, dim="dim_0", mom=2, by=by),
            xr.DataArray,
        ),
        xr.DataArray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataset, dim="dim_0", mom=2, by=by),
            xr.Dataset,
        ),
        xr.Dataset,
        None,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray_any, dim="dim_0", mom=2, by=by),
            Any,
        ),
        xr.DataArray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataset_any, dim="dim_0", mom=2, by=by),
            Any,
        ),
        xr.Dataset,
        None,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_arraylike, axis=0, mom=2, by=by),
            NDArray[Any],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float32, axis=0, mom=2, by=by, dtype=float64),
            NDArray[float64],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float64, axis=0, mom=2, by=by, dtype=float32),
            NDArray[float32],
        ),
        np.ndarray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_arrayany, axis=0, mom=2, by=by, dtype=float32),
            NDArray[float32],
        ),
        np.ndarray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_arraylike, axis=0, mom=2, by=by, dtype=float32),
            NDArray[float32],
        ),
        np.ndarray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_any, axis=0, mom=2, by=by, dtype=float32),
            Any,
        ),
        np.ndarray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float32, axis=0, mom=2, by=by, dtype="f8"),
            NDArray[Any],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray, dim="dim_0", mom=2, by=by, dtype=float32),
            xr.DataArray,
        ),
        xr.DataArray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataset, dim="dim_0", mom=2, by=by, dtype=float32),
            xr.Dataset,
        ),
        xr.Dataset,
        None,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray_any, dim="dim_0", mom=2, by=by, dtype=float32),
            Any,
        ),
        xr.DataArray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray_or_set, dim="dim_0", mom=2, by=by, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float32, axis=0, mom=2, by=by, out=group_out_float64),
            NDArray[float64],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_arraylike, axis=0, mom=2, by=by, out=group_out_float64),
            NDArray[float64],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_any, axis=0, mom=2, by=by, out=group_out_float32),
            Any,
        ),
        np.ndarray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float32, axis=0, mom=2, by=by, out=group_out_arrayany),
            NDArray[Any],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray, dim="dim_0", mom=2, by=by, out=group_out_float32),
            xr.DataArray,
        ),
        xr.DataArray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray_any, dim="dim_0", mom=2, by=by, out=group_out_float32),
            Any,
        ),
        xr.DataArray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float32, axis=0, mom=2, by=by, dtype=float32, out=group_out_float64),
            NDArray[float64],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_arraylike, axis=0, mom=2, by=by, dtype=float32, out=group_out_float64),
            NDArray[float64],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_any, axis=0, mom=2, by=by, dtype=float64, out=group_out_float32),
            Any,
        ),
        np.ndarray,
        float32,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_float32, axis=0, mom=2, by=by, dtype=float64, out=group_out_arrayany),
            NDArray[Any],
        ),
        np.ndarray,
        float64,
    ...
    check(
        assert_type(
            cmomy.reduce_vals_grouped(vals_dataarray, dim="dim_0", mom=2, by=by, dtype="f8", out=group_out_float32),
            xr.DataArray,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_reduce_vals_indexed() -> None:
    ...
    check(
        assert_type(
            cmomy.reduce_vals_indexed(vals_dataarray_or_set, dim="dim_0", mom=2, index=index, group_start=group_start, group_end=group_end, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_resample_data() -> None:
    ...
    check(
        assert_type(
            cmomy.resample_data(data_dataarray_or_set, dim="dim_0", mom_ndim=1, sampler=sampler, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_resample_vals() -> None:
    ...
    check(
        assert_type(
            cmomy.resample_vals(vals_dataarray_or_set, dim="dim_0", mom=2, sampler=sampler, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_resample_jackknife_data() -> None:
    ...
    check(
        assert_type(
            cmomy.resample.jackknife_data(data_dataarray_or_set, dim="dim_0", mom_ndim=1, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_resample_jackknife_vals() -> None:
    ...
    check(
        assert_type(
            cmomy.resample.jackknife_vals(vals_dataarray_or_set, dim="dim_0", mom=2, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_convert_moments_type() -> None:
    ...
    check(
        assert_type(
            cmomy.convert.moments_type(data_dataarray_or_set, mom_ndim=1, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_convert_cumulative() -> None:
    ...
    check(
        assert_type(
            cmomy.convert.cumulative(data_dataarray_or_set, dim="dim_0", mom_ndim=1, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_utils_vals_to_data() -> None:
    ...
    check(
        assert_type(
            cmomy.utils.vals_to_data(vals_dataarray_or_set, mom=2, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_rolling_rolling_vals() -> None:
    ...
    check(
        assert_type(
            cmomy.rolling.rolling_vals(vals_dataarray_or_set, dim="dim_0", mom=2, window=3, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_rolling_rolling_data() -> None:
    ...
    check(
        assert_type(
            cmomy.rolling.rolling_data(data_dataarray_or_set, dim="dim_0", mom_ndim=1, window=3, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_rolling_rolling_exp_vals() -> None:
    ...
    check(
        assert_type(
            cmomy.rolling.rolling_exp_vals(vals_dataarray_or_set, dim="dim_0", mom=2, alpha=0.2, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_rolling_rolling_exp_data() -> None:
    ...
    check(
        assert_type(
            cmomy.rolling.rolling_exp_data(data_dataarray_or_set, dim="dim_0", mom_ndim=1, alpha=0.2, dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_cmomy_wrap() -> None:
    ...
    check(
        assert_type(
            cmomy.wrap(data_dataarray_or_set, dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
        xr.DataArray,
...
def test_cmomy_wrap_reduce_vals() -> None:
    ...
    check(
        assert_type(
            cmomy.wrap_reduce_vals(vals_dataarray_or_set, dim="dim_0", mom=2, dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
    ...
    check(
        assert_type(
            cmomy.wrap_reduce_vals(vals_dataarray_or_set, dim="dim_0", mom=2, out=reduce_out_float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_cmomy_wrap_resample_vals() -> None:
    ...
    check(
        assert_type(
            cmomy.wrap_resample_vals(vals_dataarray_or_set, dim="dim_0", mom=2, sampler=sampler, dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
    ...
    check(
        assert_type(
            cmomy.wrap_resample_vals(vals_dataarray_or_set, dim="dim_0", mom=2, sampler=sampler, out=group_out_float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_cmomy_wrap_raw() -> None:
    ...
    check(
        assert_type(
            cmomy.wrap_raw(data_dataarray_or_set, dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
    ...
    check(
        assert_type(
            cmomy.wrap_raw(data_dataarray_or_set, out=transform_out_float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_cmomy_CentralMomentsData() -> None:
    ...
    check(
        assert_type(
            cmomy.CentralMomentsData(data_dataarray_or_set),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
...
def test_cmomy_zeros_like() -> None:
    ...
    check(
        assert_type(
            cmomy.zeros_like(central_dataarray_or_set, dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_astype() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.astype(float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_assign_moment() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.assign_moment(weight=1),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
...
def test_moments_to_comoments() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.moments_to_comoments(mom=(1, -1)),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
    ...
    check(
        assert_type(
            central_dataarray_or_set.moments_to_comoments(mom=(1, -1), dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_resample_and_reduce() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.resample_and_reduce(dim="dim_0", sampler=sampler),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
    ...
    check(
        assert_type(
            central_dataarray_or_set.resample_and_reduce(dim="dim_0", sampler=sampler, dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
    ...
    check(
        assert_type(
            central_dataarray_or_set.resample_and_reduce(dim="dim_0", sampler=sampler, out=group_out_float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_jackknife_and_reduce() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.jackknife_and_reduce(dim="dim_0"),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
    ...
    check(
        assert_type(
            central_dataarray_or_set.jackknife_and_reduce(dim="dim_0", dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
    ...
    check(
        assert_type(
            central_dataarray_or_set.jackknife_and_reduce(dim="dim_0", out=transform_out_float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_reduce() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.reduce(dim="dim_0"),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
    ...
    check(
        assert_type(
            central_dataarray_or_set.reduce(dim="dim_0", dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
    ...
    check(
        assert_type(
            central_dataarray_or_set.reduce(dim="dim_0", out=reduce_out_float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_moveaxis() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.moveaxis(0, 0),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
...
def test_new_like() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.new_like(),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float64,
    ...
    check(
        assert_type(
            central_dataarray_or_set.new_like(dtype=float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
    ...
    check(
        assert_type(
            central_dataarray_or_set.new_like(transform_out_float32),
            cmomy.CentralMomentsData[xr.DataArray | xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        float32,
...
def test_cumulative() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.cumulative(dim="dim_0"),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float64,
    ...
    check(
        assert_type(
            central_dataarray_or_set.cumulative(dim="dim_0", dtype=float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
    ...
    check(
        assert_type(
            central_dataarray_or_set.cumulative(dim="dim_0", out=transform_out_float32),
            xr.DataArray | xr.Dataset,
        ),
        xr.DataArray,
        float32,
...
def test_to_dataarray() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.to_dataarray(),
            cmomy.CentralMomentsData[xr.DataArray],
        ),
        cmomy.CentralMomentsData,
        None,
...
def test_to_dataset() -> None:
    ...
    check(
        assert_type(
            central_dataarray_or_set.to_dataset(),
            cmomy.CentralMomentsData[xr.Dataset],
        ),
        cmomy.CentralMomentsData,
        None,
