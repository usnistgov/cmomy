...
@docfiller.decorate
def rolling_vals2(  # pyright: ignore[reportOverlappingOverload]
    x: ArrayLike | xr.DataArray,
    *y: ArrayLike | xr.DataArray,
    mom: Moments,
    window: int,
    ...
    *y : array-like or DataArray
    ...
    min_periods = window if min_periods is None else min_periods
    data_tmp = np.zeros(mom_to_mom_shape(mom), dtype=dtype)
