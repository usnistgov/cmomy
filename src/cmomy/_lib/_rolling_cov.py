...
def rolling_data(
    ...
    nsamp, mom_shape0, mom_shape1 = data.shape
    dummy_mom = np.zeros((mom_shape0, mom_shape1), dtype=data.dtype)
...
def rolling_vals(
    ...
    nsamp, mom_shape0, mom_shape1 = out.shape
    dummy_mom = np.zeros((mom_shape0, mom_shape1), dtype=out.dtype)
